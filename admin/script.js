...
async function loadAlunos() {
    ...
    try {
        ...
        if (!emailsAutorizados || emailsAutorizados.length === 0) {
            container.innerHTML = '<tr><td colspan="4" style="text-align:center;">Nenhum aluno autorizado</td></tr>';
            return;
        }
        ...
        container.innerHTML = '<tr><td colspan="4" style="text-align:center; color: #ef4444;">Erro ao carregar alunos</td></tr>';
    }
}
...
async function autorizarAluno(event) {
    ...
    try {
        ...
        showAlertMessage(alert, 'Aluno autorizado com sucesso!', 'success');
        ...
        showAlertMessage(alert, 'Erro ao autorizar aluno.', 'error');
    } finally {
        btn.disabled = false;
